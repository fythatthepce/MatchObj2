...
public class Matchdetect extends Activity implements CameraBridgeViewBase.CvCameraViewListener2 {

    /**
     * class name for debugging with logcat
     */
    private static final String TAG = Matchdetect.class.getName();
    /**
     * the camera view
     */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_matchdetect);
